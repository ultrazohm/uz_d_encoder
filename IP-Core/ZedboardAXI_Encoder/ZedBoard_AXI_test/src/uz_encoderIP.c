...
float uz_encoderIP_getLOSThresh(uz_encoderIP_t* self){
	...
	int32_t addr = 0x88;
	int32_t val = uz_encoderIP_readRegister(self, addr);
...
float uz_encoderIP_getDOSResetMin(uz_encoderIP_t* self){
	...
	int32_t valMin = uz_encoderIP_readRegister(self, addrMin);
...
float uz_encoderIP_getDOSResetMax(uz_encoderIP_t* self){
	...
	int32_t valMax = uz_encoderIP_readRegister(self, addrMax);
...
void uz_encoderIP_setExcitationFrequency(uz_encoderIP_t* self, float excFreq){
	...
	uz_encoderIP_writeRegister(self, addr, fCW);
}
...
void uz_encoderIP_setCTRLReg(uz_encoderIP_t* self, int32_t register_value){
	...
	uz_encoderIP_writeRegister(self, addr, register_value);
}

float uz_encoderIP_getCTRLReg(uz_encoderIP_t* self){

	int32_t addr = 0x92;
	int32_t register_value = uz_encoderIP_readRegister(self, addr);
...
void uz_encoderIP_resetSoftware(uz_encoderIP_t* self){
	...
	uz_encoderIP_writeRegister(self, addr, 0x00);
